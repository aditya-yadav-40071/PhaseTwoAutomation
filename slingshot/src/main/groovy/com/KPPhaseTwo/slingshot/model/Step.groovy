package com.KPPhaseTwo.slingshot.model
...
class Step {
    ...
    def step = new com.KPPhaseTwo.slingshot.aggregator.report.Step()
	...
	def cloneMe () {
		...
		cloned.step = new com.KPPhaseTwo.slingshot.aggregator.report.Step();
		cloned.data = null;
		return cloned;
	}
