package com.knowledgePodium.tools

import com.gargoylesoftware.htmlunit.ElementNotFoundException

//import com.knowledgePodium.app.Page
...
import com.knowledgePodium.utils.*
...
//		fileInput.sendKeys(location);
	...
	public def scrollToElement(def element){
		WebElement element1 = driver.findElement(By.xpath("id_of_element"))
